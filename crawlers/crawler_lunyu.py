...
# Configuration
GROUP_ID = "88512521148542"
COLUMN_ID = "8188411542" # 论语专栏ID
...
HEADERS = {
    ...
    "x-aduid": "5e7a2678e-e8d5-eb5c-08e4-af283659d53", # from latest curl
    "x-request-id": "53b33e0c7-6f1b-a89e-b0a8-f68e4667b4f", # from latest curl
    "x-signature": "787e6e26b9d2fedb12dc9354e827a3ac1c6da566", # from latest curl
    "x-timestamp": "1765981868", # from latest curl
    "x-version": "2.85.0"
}

OUTPUT_FILE = "lunyu_column_posts.json"
