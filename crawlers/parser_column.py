...
def parse_post(post):
    ...
    elif 'q_and_a' in post: # Handle Q&A type if present
    ...
    return {
        ...
        'title': post.get('title', '') # Sometimes columns have titles
    }
...
def generate_markdown(posts):
    ...
    # Sort by date (oldest first usually makes sense for reading a series)
    # The API 'direction=desc' returns newest first. We reverse to read chronological.
