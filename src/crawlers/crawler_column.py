...
# Configuration
# Old Hashtag URL: https://api.zsxq.com/v2/hashtags/28888181858221/topics
# New Column URL: https://api.zsxq.com/v2/groups/15284248885222/columns/2158421821/topics
GROUP_ID = "15284248885222"
COLUMN_ID = "2158421821"
...
HEADERS = {
    ...
    "x-request-id": "071b3e90b-17e2-5922-479f-689cdaa262d",
    "x-signature": "0166950b4eb4322d8ae218026aea986a7e425eea",
    "x-timestamp": "1765980274",
    "x-version": "2.85.0"
}

OUTPUT_FILE = "sunzi_bingfa_column_posts.json"
...
def fetch_topics(end_time=None):
    ...
    if end_time:
        # Assuming pagination works similarly with end_time
