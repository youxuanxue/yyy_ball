...
|---|---|---|
| Script prompt | `series/prompts/moneywise_script.prompt` | `lesson-content-planning` |
| Animation prompt | `series/prompts/moneywise_annimate.prompt` | `lesson-animation-authoring` |
